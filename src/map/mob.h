...
#define MAX_MOBMESSAGGES 10
#define MAX_MOBTALKSTATE 7
#define MAX_MOBTALKPERC 1000
#define MOBTALK_DELAY 2000
...
struct mob_db
{
	...
	unsigned short allowed_to_talk;
	struct{
		char messagges[MAX_MOBMESSAGGES][256];
		int n;
		int perc;
	} messagges[MAX_MOBTALKSTATE];
};
